...
urlpatterns = [
    ...
    path('career-listings/received-applications/', views.all_listings_with_received_applicants, name='all_listings_with_received_applicants'),

    path('career-listings/received-applications/<int:job_id>/applications/', views.job_listing_applicants, name='job_listing_applicants'),
    path('career-listings/received-applications/<int:job_id>/applications/applicant/<int:applicant_id>', views.manage_applicant, name='manage_applicant'),
    ...
    path('career-listings/received-applications/<int:job_id>/applications/applicant/<int:applicant_id>/reject-applicant',
    ...
    path('career-listings/profile/email-verification/send-otp/', views.profile_verification_send_otp_to_email, name='profile_verification_send_otp_to_email'),
    path('career-listings/profile/email-verification/verify-otp/', views.profile_verification_verify_otp, name='profile_verification_verify_otp'),
